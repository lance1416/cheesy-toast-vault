// Shared SVG icon components — stateless, no "use client" needed.

export function EyeIcon({ open, size = 14 }: { open: boolean; size?: number }) {
  return open ? (
    <svg
...
export function DotsHorizontalIcon({ size = 15 }: { size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CreditCardIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function IdentityIcon({ size = 14 }: { size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
